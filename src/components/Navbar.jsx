  ...
  return (
    <nav className="bg-neutral-900 text-white px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center w-full">
          <div className="flex-1 flex">
            <input
              type="text"
              placeholder="Search"
              className="bg-gray-900 border border-gray-600 rounded-l-full px-4 py-2 w-full focus:outline-none focus:border-blue-500 text-white placeholder-gray-400"
            />
            <button className="bg-gray-800 border border-l-0 border-gray-600 rounded-r-full px-6 py-2 hover:bg-gray-700 transition-colors">
              <Search size={20} />
            </button>
          </div>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button className="flex items-center space-x-2 border border-gray-600 rounded-full px-3 py-1.5 hover:bg-gray-800 transition-colors">
          <User size={20} />
